<template>
  <div class="resume-main grid md:grid-cols-[70%_30%] gap-4 text-base">
    <div class="resume-header md:col-span-2 pb-4">
      <div class="flex flex-col md:flex-row justify-between">
        <div class="uppercase">
          <h1 class="text-6xl font-semibold">Giovanni Oda</h1>
          <h3 class="text-2xl">Full Stack Software Engineer</h3>
          <div class="flex flex-col items-start mt-2 md:flex-row md:items-center">
            <a
              href="https://api.whatsapp.com/send?phone=5561984022100&text=Hello."
              target="_blank">
              <p class="flex items-center">
                ...
                <span class="text-primary">+55 61 98402-2100</span>
              </p>
            </a>
            <a
              href="mailto:contact@giovannioda.dev"
              target="_blank">
              <p class="flex items-start mt-1 md:mx-6 md:mt-0 lowercase">
                <span class="material-icons mr-2 text-lg">mail</span>
                <span class="text-primary">contact@giovannioda.dev</span>
              </p>
            </a>
          </div>
        </div>
        <div class="pr-4">
          <ul>
            <a
              href="https://giovannioda.dev"
              target="_blank">
              <li class="flex items-start">
                <span class="material-icons mr-2 text-lg">public</span>
                <span class="text-primary">www.giovannioda.dev</span>
              </li>
            </a>
            <a
              href="https://www.linkedin.com/in/giovanni-oda/"
              target="_blank">
              <li class="flex items-end mb-1">
                <svg
                  class="h-5 w-5 mr-2"
                  viewBox="0 0 24 24"
                  fill="currentColor">
                ...
                <span class="text-primary">
                  linkedin.com/in/<span class="font-semibold">giovanni-oda</span>
                </span>
              </li>
            </a>
            <a
              href="https://github.com/giovanni-oda"
              target="_blank">
              <li class="flex items-end">
                ...
                <span class="text-primary">
                  github.com/<span class="font-semibold">giovanni-oda</span>
                </span>
              </li>
            </a>
          </ul>
    ...
    <div class="resume-col-left pr-4">
      <section class="exp-section">
        <h3 class="uppercase text-xl font-semibold">Experience</h3>
        <div class="max-w-[50px] h-[3px] rounded mr-auto bg-secondary mt-2 mb-2"></div>
        <article
          v-for="(exp, index) in expList"
          :key="index"
          class="border-b pt-3 pb-4"
          :class="{ 'border-black/10': !darkMode, 'border-black/20': darkMode }">
          <div class="grid grid-cols-[2fr_1fr]">
            <div>
              <h4 class="font-semibold">{{ exp.company }}</h4>
              <div class="text-sm flex flex-col mt-1 md:flex-row">
                <p
                  v-for="(role, index) in exp.roles"
                  :key="index">
                  {{ role }}
                  <span
                    v-show="index + 1 < exp.roles.length"
            ...
            <div>
              ...
              <span class="text-sm font-normal">{{ exp.period }}</span>
            </div>
          </div>
          <div class="mt-2">
      ...
      <section class="project-section mt-6">
        <h3 class="uppercase text-xl font-semibold">Projects</h3>
        <div class="max-w-[50px] h-[3px] rounded mr-auto bg-secondary mt-2 mb-2"></div>
        <article
          v-for="(project, index) in projectList"
          :key="index"
          class="border-b border-black/10 pt-3 pb-4">
          <div class="grid grid-cols-[2fr_1fr]">
            <div>
              ...
              <div class="text-sm flex flex-col mt-1 md:flex-row">
                <p
                  ...
                  <span
                    v-show="index + 1 < project.links.length"
                    class="hidden mx-1 opacity-60 md:inline-block">
                    |
                  </span>
                </p>
              </div>
            ...
            <div>
              <h4 class="font-semibold">{{ project.role }}</h4>
              <!-- <span class="text-sm font-normal">March/20 - November/22</span> -->
            </div>
          </div>
          <div class="mt-2">
            <p>
    ...
    <div class="resume-col-right pr-4">
      <section class="project-section">
        <h3 class="uppercase text-xl font-semibold">About</h3>
        <div class="max-w-[50px] h-[3px] rounded mr-auto bg-secondary mt-2 mb-2"></div>
        <div class="pt-3">
          <p>
      ...
      <section class="project-section mt-10">
        <h3 class="uppercase text-xl font-semibold">Skills</h3>
        <div class="max-w-[50px] h-[3px] rounded mr-auto bg-secondary mt-2 mb-2"></div>
        <div
          v-for="(type, index) in Object.keys(skills)"
          :key="index">
          <h4 class="text-xs font-semibold uppercase opacity-40 pt-3 pb-2">{{ type }}</h4>
          <div class="flex flex-wrap">
            <p
              v-for="(skill, index) in skills[type]"
              :key="index"
              class="chip text-xs text-zinc-600 px-2 py-1 mr-2 mb-3">
              {{ skill }}
            </p>
          </div>
        </div>
      ...
      <section class="project-section mt-10">
        <h3 class="uppercase text-xl font-semibold">Education</h3>
        <div class="max-w-[50px] h-[3px] rounded mr-auto bg-secondary mt-2 mb-2"></div>
        <div class="pt-3">
          <h3 class="text-base font-semibold">UNIP - Universidade Paulista</h3>
          <p>
            The
            <a
            ...
            is present in more than 900 locations in Brazil.
          </p>
          <div class="mt-2 pl-2">
            <p>
              <span class="text-primary font-bold"> • </span>
              <span class="font-semibold"> Bachelor of Communication - Advertising</span> (Feb/2006
              - Dez/2010)
            </p>
          </div>
        </div>
      ...
      <section class="project-section mt-10">
        <h3 class="uppercase text-xl font-semibold">Languages</h3>
        <div class="max-w-[50px] h-[3px] rounded mr-auto bg-secondary mt-2 mb-2"></div>
        <div class="pt-3">
          <p>
            <span class="text-base font-semibold mr-2">Portuguese:</span>
            <span>Native</span>
          </p>
          <p class="mt-2">
            <span class="text-base font-semibold mr-2">English:</span>
            <span>
              Listening - Advanced <span class="mx-1 opacity-40">|</span> Reading - Advanced
              <span class="mx-1 opacity-40">|</span> Speaking - Intermediary
              <span class="mx-1 opacity-40">|</span> Writing - Intermediary
            </span>
          </p>
        </div>
      </section>
      <section class="project-section mt-10">
        <h3 class="uppercase text-xl font-semibold">Interests</h3>
        <div class="max-w-[50px] h-[3px] rounded mr-auto bg-secondary mt-2 mb-2"></div>
        <div class="pt-3">
          <p>
            Open Source <span class="mx-1 opacity-40">|</span> Video Games
            <span class="mx-1 opacity-40">|</span> Technology
            <span class="mx-1 opacity-40">|</span> Supersport Motorcycles
            <span class="mx-1 opacity-40">|</span> Running
          </p>
        </div>
      </section>
    </div>
