          ...
          <ul class="mt-8">
            ...
            <a
              ...
              <li class="flex items-center my-3">
                ...
                <span> +55 61 98402-2100</span>
              </li>
            </a>
          </ul>
        </div>
        <div class="mt-6 mb-12 lg:my-12">
          <h3 class="text-2xl font-bold uppercase">Other Channels</h3>
          <div class="max-w-[50px] h-[3px] rounded bg-secondary mt-3"></div>
          <ul class="mt-8">
            <li class="my-3">
              <a
                ...
                linkedin.com/in
                <span class="font-semibold"> /giovanni-oda </span>
              </a>
            </li>
            <li class="my-3">
              <a
